...
class TrendReq(object):
    ...
    def interest_over_time(self):
        ...
        # print(json.dumps(self.interest_over_time_widget['request']))
        request_dict = self.interest_over_time_widget['request']
        request_dict["resolution"] = "WEEK"
    ...
    def get_historical_interest(self, keywords, start_year, cat=0, geo='', gprop='', sleep=0):
        ...
        tf = str(start_year) + '-01-01 ' + str(start_year + 5) + '-01-01'
        # tf = "2016-01-01 2019-03-29"
